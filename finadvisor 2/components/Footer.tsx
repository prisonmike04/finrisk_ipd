    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link href="/resources" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Resources
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/case-studies" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Case Studies
            </Link>
          </div>
          <div className="px-5 py-2">
        ...
        <p className="mt-8 text-center text-base text-gray-400">
          &copy; 2023 Financial Risk Assessment Platform. All rights reserved.
        </p>
      </div>
    </footer>
  )
